package com.zhangnew.tdi2.hotfix;
...
import com.zhangnew.tdi2.hook.Tdi2Hook;
...
/**
 * @author shuihuadx
 * url https://github.com/shuihuadx/XposedHook
 * url https://blog.csdn.net/u011956004/article/details/78612502
...
public class HookLoader implements IXposedHookLoadPackage, IXposedHookZygoteInit {
     ...
     */
    private final static String modulePackageName = "com.zhangnew.tdi2";

    /**
     * 实际hook逻辑处理类
     */
    private final String handleHookClass = Tdi2Hook.class.getName();
